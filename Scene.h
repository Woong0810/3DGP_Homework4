...
private:
	...
	void FireLevel2PlayerProjectileAtTarget(int nTargetIndex);
	void FireLevel2EnemyProjectile(int nEnemyIndex);
	...
	CProjectileObject			**m_ppLevel2EnemyProjectiles = NULL;
	int							m_nLevel2EnemyProjectiles = 0;
	float						m_fLevel2EnemyFireCooldown = 0.0f;
	float						m_fLevel2AutoAttackCooldown = 0.0f;
	int							m_nLevel2SelectedEnemyTankIndex = -1;
	bool						m_bLevel2AutoAttack = false;
	bool						m_bLevel2Shield = false;
